function RingNetworkAnswerPlot
%%%%%%%% Coding the input %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% figure; plot(h_ext, 'linewidth',3); 
% xlabel('pref. orentation','fontsize',30); 
% ylabel('h_{ext}','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'Hext')
...
%Uncomment if you want to see a plot
% figure; plot(-15:15,activation_f(-15:15,0,0.1), 'linewidth',3);
% xlabel('input h','fontsize',30); 
% ylabel('activation function g','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'g')
...
% figure;image(simul0*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'c12')
% figure;image(simul1*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'c15')
% figure;image(simul2*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
...
%Uncomment if you want to have some plots
% figure; image(con)
% xlabel('pre neuron index','fontsize',30); 
% ylabel('post neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'J')
...
%Uncomment if you want to have some plots
% figure;image(simul_c0*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'cc12')
% figure;image(simul_c1*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'cc15')
% figure;image(simul_c2*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
...
% figure; image(simul_c3*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'cc_30')
% figure; image(simul_change*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
...
% simul_c3 = simulation_c(m, theta0, n_neurons, t_steps, 0.8, 8) ;
% theta1=(2*pi)/3;
% simul_change = simulation_c(simul_c3(:,30), theta1, n_neurons, 30,  0.8, 8) ;
% figure; image(simul_c3*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'cc_30_noJ')
% figure; image(simul_change*100);
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'cc_100_noJ')
...
% figure;image(simul_nostim*100);xlabel('time'); 
% xlabel('time','fontsize',30); 
% ylabel('neuron index','fontsize',30)
% set(gca,'fontsize',30);
% set(gca,'YDir','normal')
% print('-depsc', 'remov_inp')
